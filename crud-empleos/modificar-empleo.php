...
if(!empty($_POST["btnmodificar"])){
        ...
        echo "<div class='alert alert-warning'>La ciudad debe contener solo letras y comas.</div>";
    } else if (!preg_match('/^\d{1,3}(?:\.\d{3})*(?:,\d+)?$/', $sueldo)) {
        echo "<div class='alert alert-warning'>El sueldo debe contener solo números.</div>";
    } else {   
